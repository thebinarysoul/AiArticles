...
@Slf4j
public class ChatBots extends Site {
    @Override
    public List<Article> getArticles() {
        try {
            Document document = Jsoup.connect("https://chatbotslife.com/latest")
            ...
            log.error("Failed parsing https://chatbotslife.com/latest: ", e);
        }
